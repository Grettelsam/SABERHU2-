...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user === $usuario_valido && $password === $password_valida) {
        echo '<div id="alert-success" class="alert alert-success text-center" role="alert">
                <strong>Login exitoso.</strong> ¡Bienvenido!
              </div>';
        echo '<script>
                setTimeout(function() {
        ...
        echo '<div id="alert-error" class="alert alert-danger text-center" role="alert">
                <strong>Error:</strong> Credenciales incorrectas. Redirigiendo...
              </div>';
        echo '<script>
                setTimeout(function() {
